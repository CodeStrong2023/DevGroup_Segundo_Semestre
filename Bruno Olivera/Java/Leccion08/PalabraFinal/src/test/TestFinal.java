...
clases: evita que creen clases hijas
...
en una constante.
el ejemplo de esto es la clase math, donde todos sus atributos son de 
tipo static y final, es por esto que la variable pi se conoce como una
contante
*/
package test;
