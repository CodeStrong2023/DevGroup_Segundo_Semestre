/*
Ejercicio 3: leer 5 numeros, guardarlos en un arreglo y 
a continuacion realizar la media de los numeros positivos,
la media de los negativos y contar el numero de 0
*/
...
public class Arreglos_Ejercicio_3 {
    ...
    public static void main(String[] args) {
        ...
        if (conteo_negativos == 0){
            ...
            System.out.println("La media de los numero positivos es = " + mediaNegativos);
        }
