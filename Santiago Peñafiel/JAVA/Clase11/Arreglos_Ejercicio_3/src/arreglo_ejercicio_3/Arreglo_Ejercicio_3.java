...
realizar las media de los numeros positivos, la media de los negativos y contar el 
numero de ceros
 */
...
public class Arreglo_Ejercicio_3 {
    public static void main(String[] args) {
        ...
        if(conteo_positivos == 0){
            System.out.println("\n No se puede sacar la medida de los positivos ");
        }
        else{
        ...
        if(conteo_negativos==0){
            System.out.println("\n No se puede sacar la medida de los negativos ");
        }
        else{
