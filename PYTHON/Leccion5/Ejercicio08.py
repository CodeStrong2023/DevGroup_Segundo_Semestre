...
Hacer un programa que simule un cajero automatico con un saldo inicial de $1000 y trendra
...
while True:
    ...
    if opcion == 1:
        ...
        saldo += extra
        print(f"Dinero en la ceunta al momento: ${saldo}")
    elif opcion ==2:
        ...
        print(f"Dinero en la cuenta al moento: ${saldo}")
    elif opcion ==4:
